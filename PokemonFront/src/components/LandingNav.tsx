        ...
        <div className='content'>
            ...
            <div className='list flex justify-end mr-10'>
                <ul className='flex mt-5'>
                    <Link to={"/pokemon"}><li className='mr-3 bg-blue-500 p-2 text-white rounded-md'>Sign Up</li></Link>
                    <li className="mr-3 bg-blue-500 p-2 text-white rounded-md" >Log In</li>
                </ul>
            </div>
        </div>
    </div>
